...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'experience.count', 'Renamedpackage.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('experience', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.experience,
        }
      : null,
    hasAccess('renamedpackage', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'Renamedpackage',
          header: 'Renamedpackage',
          accessorKey: 'Renamedpackage',
          cell: ({ row: { original: record } }: any) => record?._count?.Renamedpackage,
        }
      : null,
