...
export const getRenamedpackages = async (
  query?: RenamedpackageGetQueryInterface,
): Promise<PaginatedInterface<RenamedpackageInterface>> => {
  const response = await axios.get('/api/renamedpackages', {
    params: query,
